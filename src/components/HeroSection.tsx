      ...
      <div className="container-site relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <motion.div
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-xl mx-auto lg:mx-0">The Founding Members invite SMEs across Merseyside are invited to join the UK's first Clearing Club. Simply and safely share invoice data. Clever tech gets everyone paid.
